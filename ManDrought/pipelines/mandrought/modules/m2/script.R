setwd("/home/cpea714/Studentship/ManDrought/pipelines/mandrought/modules/m2")
compact.df <- readRDS("/home/cpea714/Studentship/ManDrought/pipelines/mandrought/modules/m1/compact.df.rds")
